...
if(isset($_POST['name'])){
  ...
  if($con->query($sql) == true){
      ...
      $_SESSION['status'] = "<p style='color:green; font-size:20px;'>Thanks for the registration.We are happy to see you joining with us.</p>";
      $insert = true;
  }
  else{
...
<body>
    <div class="container">
        ...
        /*
        if($insert == true){
            echo "<p style='color:green; font-size:20px;'>Thanks for submitting your form.We are happy to see you joining us for the Goa Trip</p>";
        }
        */
        ?>
        -->
